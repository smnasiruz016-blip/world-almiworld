...
export type ProductKey = "job" | "salary" | "study" | "cv" | "prep" | "pte" | "toefl" | "oet" | "det" | "celpip" | "goethe" | "french" | "spanish" | "japanese";
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    key: "toefl",
    name: "AlmiTOEFL",
    tagline: "TOEFL iBT exam practice with honest AI feedback.",
    origin: "https://almitoefl.almiworld.com",
    countryUrl: () => "https://almitoefl.almiworld.com",
    countryRoleUrl: null,
  },
  {
    key: "oet",
  ...
  },
  {
    key: "det",
    name: "AlmiDET",
    tagline: "Duolingo English Test practice with honest AI feedback.",
    origin: "https://almidet.almiworld.com",
    countryUrl: () => "https://almidet.almiworld.com",
    countryRoleUrl: null,
  },
  {
    key: "celpip",
    name: "AlmiCELPIP",
    tagline: "CELPIP practice for Canadian immigration with honest AI feedback.",
    origin: "https://almicelpip.almiworld.com",
    countryUrl: () => "https://almicelpip.almiworld.com",
    countryRoleUrl: null,
  },
  {
    key: "goethe",
  ...
  },
  {
    key: "spanish",
    name: "AlmiSpanish",
    tagline: "DELE, SIELE & CCSE Spanish exam practice with honest AI feedback.",
    origin: "https://almispanish.almiworld.com",
    countryUrl: () => "https://almispanish.almiworld.com",
    countryRoleUrl: null,
  },
  {
    key: "japanese",
    name: "AlmiJapanese",
    tagline: "JLPT Japanese exam practice with honest AI feedback.",
    origin: "https://almijapanese.almiworld.com",
    countryUrl: () => "https://almijapanese.almiworld.com",
    countryRoleUrl: null,
  },
];
